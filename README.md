...
This project is an advanced autoclicker which automates the modification of player loadouts in the game *Arma 3*. 
...
4. Open Options / Video / Display settings and set the Display mode to Fullscreen Window (run Arma3 on your primary display). Set the interface size to _Small_.
...
9. Let the script run, do not touch anything. By default it will check 100 ACE loadouts and 300 Vanilla arsenals.
...
I encourage you to check the corresponding .py scripts before you run executables on your system and if you can, I encourage you to run the python scripts, details is [How to run the scripts]().
